...
public class PlayerController : MonoBehaviour
{
    ...
    public AudioClip BeepPlusTwo;
    public AudioClip OilExplosion;
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("HighQualityPetrol"))
        {
            other.gameObject.SetActive(false);
            ...
            // Update the count display.
            SetCountText();
            audioSource.PlayOneShot(BeepPlusTwo);
        ...
        if (other.gameObject.CompareTag("Oil"))
        {
            ...
            // Update the count display.
            SetCountText();
            audioSource.PlayOneShot(OilExplosion);
        }
